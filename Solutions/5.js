...
из разложений чисел в диапазоне n, m, причём из показателей степени этого множителя берётся наибольший. */
...
function getLCM(n, m) {
  ...
  /* для определения наибольшей степени для каждого простого множителя в массиве primeFactorsArr перебираем массив в цикле, в 
    итоге для каждого простого множителя получится только один массив с наибольшей длиной, оставшиеся отбрасываются*/
